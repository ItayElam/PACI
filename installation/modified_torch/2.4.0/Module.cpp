...
static PyObject* THPModule_setFreezeVersionUpdate(PyObject* module, PyObject* arg) {
    HANDLE_TH_ERRORS
    if (!PyBool_Check(arg)) {
    ...
    bool flag_value = (arg == Py_True);
    c10::freeze_version_update = flag_value;
...
static PyMethodDef TorchMethods[] = { // NOLINT
    ...
    {"freeze_version_update", THPModule_setFreezeVersionUpdate, METH_O, "Sets the flag to control tensor version updates"},
